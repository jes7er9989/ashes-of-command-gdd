    ...
    return `
      <section class="dashboard-section">
        ...
        <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-bottom:32px;">
          <div class="card card-accent" style="border-left-color:var(--terran);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'" onclick="location.hash='#ch1'"><strong style="color:var(--text-hi);font-size:1rem">4X Grand Strategy</strong><br><span style="color:var(--text-mid);font-size:0.9rem">The macro-war. Explore dead systems, expand supply chains, exploit Aethyn ruins, and exterminate rivals. You are an emperor managing a galaxy-spanning war machine across dozens of cycles.</span></div>
          <div class="card card-accent" style="border-left-color:var(--horde);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'" onclick="location.hash='#ch17'"><strong style="color:var(--text-hi);font-size:1rem">RTS Auto-Battler</strong><br><span style="color:var(--text-mid);font-size:0.9rem">The micro-war. Strategic decisions are locked in before the drop pods hit. Once combat starts, you act as overwatch command \u2014 firing off CP abilities and calling reserves while your customized units execute the battle autonomously.</span></div>
          <div class="card card-accent" style="border-left-color:var(--revenant);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'" onclick="location.hash='#ch33'"><strong style="color:var(--text-hi);font-size:1rem">Rogue-Lite Meta-Progression</strong><br><span style="color:var(--text-mid);font-size:0.9rem">A fresh procedural galaxy per simulation. Death resets the map, but the Commander\u2019s mind remembers. The Archive preserves blueprints, lore, and persistent power upgrades across runs.</span></div>
          <div class="card card-accent" style="border-left-color:var(--shards);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'" onclick="location.hash='#ch3'"><strong style="color:var(--text-hi);font-size:1rem">Deep Narrative Layers</strong><br><span style="color:var(--text-mid);font-size:0.9rem">You aren\u2019t a nameless cursor. You are a biological clone, a psychic echo, or a cold machine. Your choices have gravity, your advisors have faces and secrets, and the galaxy\u2019s history is a tragedy waiting to be uncovered.</span></div>
        </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:32px;">
          ...
          <div class="card" style="cursor:pointer;transition:border-color 0.2s,box-shadow 0.2s" onmouseover="this.style.boxShadow='0 0 12px rgba(0,180,255,0.15)'" onmouseout="this.style.boxShadow=''" onclick="location.hash='#ch12'">
            ...
            <div style="font-size:0.85rem;color:var(--text-mid);line-height:1.6">
              ...
              <div style="padding-left:14px;position:relative"><span style="position:absolute;left:0;color:rgba(0,180,255,0.3)">\u25B8</span>20 building types per faction: Supply Depot / Relay Station / Logistics Hub (MVP locked)</div>
            </div>
          </div>
  ...
  buildFiveDifferentiators() {
    return `
      <section class="dashboard-section">
        ...
        <div style="display:grid;grid-template-columns:1fr;gap:10px;margin-bottom:32px;">
          <div class="card card-accent" style="border-left-color:var(--terran);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'" onclick="location.hash='#ch17'"><strong style="color:var(--text-hi);font-size:1rem">1. The Auto-Battle General Fantasy.</strong> <span style="color:var(--text-mid);font-size:0.9rem">The 80/20 split. 80% planning, 20% intervention. You prepared the army, chose equipment, set the formation, positioned the deployment \u2014 now watch, intervene with CP abilities at critical moments, and commit reserves when the line breaks. You are the general at the holographic map, not the soldier in the trench.</span></div>
          <div class="card card-accent" style="border-left-color:var(--shards);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'" onclick="location.hash='#ch22'"><strong style="color:var(--text-hi);font-size:1rem">2. Units That Become People.</strong> <span style="color:var(--text-mid);font-size:0.9rem">Units gain names, traits, and grudges. Generals develop personalities that alter their autonomous behavior. Continuous promotion from anonymous Rookie to autonomous General who commands entire sectors, develops personality traits, forms rivalries, and can defect with their entire fleet if mistreated. Kill-count thresholds: Veteran=3, Elite=8, Commander=15, General=25. When a veteran squad dies, it leaves a permanent hole in your strategy.</span></div>
          <div class="card card-accent" style="border-left-color:var(--horde);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'" onclick="location.hash='#ch33'"><strong style="color:var(--text-hi);font-size:1rem">3. Procedural Destiny.</strong> <span style="color:var(--text-mid);font-size:0.9rem">Cross-run behavioral profile GENERATES the endgame galaxy. An aggressive player wakes to a militarized galaxy. A diplomatic player wakes to trade routes and alliances. The simulation shaped the reality you must survive.</span></div>
          <div class="card card-accent" style="border-left-color:var(--revenant);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'" onclick="location.hash='#ch20'"><strong style="color:var(--text-hi);font-size:1rem">4. The Dual-Threat Weapon Asymmetry.</strong> <span style="color:var(--text-mid);font-size:0.9rem">Energy weapons work on Vorax but HEAL Core Guardians. Kinetic weapons work on Guardians but are overwhelmed by Vorax numbers. Maintain two armies, re-equip constantly, or pursue rare hybrid weapons.</span></div>
          <div class="card card-accent" style="border-left-color:var(--guardians);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'" onclick="location.hash='#ch33'"><strong style="color:var(--text-hi);font-size:1rem">5. The Galactic Compendium.</strong> <span style="color:var(--text-mid);font-size:0.9rem">A living document that fills as you play \u2014 500\u2013800 entries across three narrative voices: Commander Notes, AI Data Entries, and Advisor Commentary. It persists across all campaigns and becomes a personal record of everything discovered, fought, and survived.</span></div>
        </div>
        <div class="divider"></div>
      </section>`;
  },
  ...
  buildVisualBenchmarks() {
    return `
      <section class="dashboard-section">
        ...
        <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-bottom:32px;">
          <div class="card card-accent" style="border-left-color:var(--terran);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'"><strong style="color:var(--text-hi);font-size:1rem">StarCraft II</strong><br><span style="color:var(--text-mid);font-size:0.9rem">The benchmark for visual readability. Triple-redundant unit identification: faction color + unique silhouette + health bars.</span></div>
          <div class="card card-accent" style="border-left-color:var(--horde);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'"><strong style="color:var(--text-hi);font-size:1rem">Dawn of War: Dark Crusade</strong><br><span style="color:var(--text-mid);font-size:0.9rem">Territory conquest. Every captured sector is a place with history and strategic weight, not just a hex on a board. The grim, heavy atmosphere of total war.</span></div>
          <div class="card card-accent" style="border-left-color:var(--shards);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'"><strong style="color:var(--text-hi);font-size:1rem">Stellaris</strong><br><span style="color:var(--text-mid);font-size:0.9rem">Grand strategy at galactic scale. The model for 4X scope, procedural narratives, and faction asymmetry across hundreds of star systems.</span></div>
          <div class="card card-accent" style="border-left-color:var(--revenant);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'"><strong style="color:var(--text-hi);font-size:1rem">Command &amp; Conquer 3</strong><br><span style="color:var(--text-mid);font-size:0.9rem">Diegetic UI. The interface IS your military command console. Faction-specific UI skins with a clean, holographic projection aesthetic.</span></div>
          <div class="card card-accent" style="border-left-color:var(--vorax);cursor:pointer;transition:opacity 0.2s,border-color 0.2s" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'"><strong style="color:var(--text-hi);font-size:1rem">Warhammer 40K</strong><br><span style="color:var(--text-mid);font-size:0.9rem">Unmistakable faction identity. Every unit must be instantly recognizable from a black-and-white silhouette alone.</span></div>
        </div>
        <div class="divider"></div>
      </section>`;
  },
